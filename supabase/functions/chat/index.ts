// Main chat endpoint for FinBuddy AI assistant
import { serve } from "https://deno.land/std@0.208.0/http/server.ts"
import { corsHeaders, REQUEST_TIMEOUT, RATE_LIMIT } from "../_shared/config.ts"
import { requiresNewsContext } from "../_shared/message-analyzer.ts"
import { generateAIResponse } from "../_shared/ai-response-generator.ts"
import { newsStorageService } from "../_shared/news-storage.ts"
import { ChatRequest, ChatResponse } from "../_shared/types.ts"
